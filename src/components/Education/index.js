            ...
            <div className='relative mx-12 w-[1250px] flex justify-center items-center bg-[#386FA4] rounded-lg'>
                ...
                <div className='flex flex-col md:flex-row flex-wrap justify-center items-center p-8 pt-12'>
                    ...
                    <div className='flex flex-col justify-center items-center w-2/3 md:w-1/3 ml-2 lg:ml-4'>
                        ...
                        className='text-sm font-bold text-white hover:text-[#91E5F6] hover:tracking-widest hover:underline hover:scale-110 duration-200 ease-out transition-all'>View Credly Badge</a>
                    </div>
                </div>
