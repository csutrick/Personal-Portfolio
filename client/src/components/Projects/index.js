...
import pic from '../../Assets/project-thumbnails/Untitled-1.png';
    ...
    return (
        <section className='w-full flex justify-center py-16'>
            <div className='mx-12 w-[1250px] flex flex-col md:flex-row items-center justify-between flex-wrap'>
                ...
                className='group relative flex h-[300px] w-[100%] mb-12 transition-all duration-300 ease-in-out
                rounded-xl drop-shadow-md hover:drop-shadow-2xl border-8 border-[#84D2F6] hover:border-[#59A5D8] hover:scale-[1.02]
                bg-center bg-cover bg-no-repeat backdrop-blur-none hover:backdrop-blur-sm' style={{ backgroundImage: `url(${pic})` }}>
                    ...
                    <a href="https://github.com/csutrick" className='absolute bottom-0 right-0 p-2 '>
