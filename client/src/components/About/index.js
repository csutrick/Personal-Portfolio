        ...
        <section className='w-full flex justify-center' id="about">
            <div className='mx-12 mt-36 mb-16 w-[1250px] flex flex-col md:flex-row justify-evenly items-center'>
                ...
                <div className='order-1 md:order-2 flex flex-col items-center'>
                    ...
                    <button className='group flex justify-center items-center w-[50%] px-6 py-4 mb-4 md:mb-0 bg-[#84D2F6] active:bg-[#59A5D8] border-4 border-[#84D2F6] hover:border-[#7ec8eb] text-white font-bold rounded-lg text-2xl
